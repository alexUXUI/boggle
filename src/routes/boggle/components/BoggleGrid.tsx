          ...
          {Array.from({ length: boardSize }, (idx, i) => (
            <tr class={`flex w-full`}>
              {Array.from({ length: boardSize }, (jdx, j) => {
                ...
                return (
                  <td
                    class={` border-[1px]bg-blue-800 border-blue-800 hover:cursor-pointer m-[1px] text-[40px] flex justify-center items-center rounded-sm`}
                    style={{
                  ...
                  >
                    <button
                      ...
                      class={`w-[50px] ${bgColor} h-[50px] leading-[40px] p-0 m-0 rounded-md`}
                      onTouchMove$={(e) => {
