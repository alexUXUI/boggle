...
export const Controls = component$(({ state, answersLength }: Props) => {
  return (
    <div class="flex max-w-[500px] m-auto items-center justify-center mt-4 bg-white z-10">
      <details class="p-4 bg-white flex justify-center items-center flex-col rounded-md w-full max-w-[500px]">
        <summary>Board Configurations</summary>
        <div
          class="flex flex-col max w-full max-w-[500px]"
        ...
        >
          ...
          <div class="flex min w-full max-w-[500px] max">
            <fieldset class="flex my-2 h-[30px] justify-center items-center">
