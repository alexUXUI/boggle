...
function __wbg_adapter_18(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hacc87f43b233a39d(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {string}
*/
export function get_board_string(board) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.get_board_string(retptr, addHeapObject(board));
...
* @returns {Promise<Array<any>>}
*/
export function run_game(dictionary, board) {
    const ret = wasm.run_game(addHeapObject(dictionary), addHeapObject(board));
    return takeObject(ret);
}
...
function __wbg_adapter_56(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h6754e14fab034f5d(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
function getImports() {
    ...
    imports.wbg.__wbg_log_5f9068f46b049aa4 = function(arg0, arg1) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('boggle_solver_bg.wasm', import.meta.url);
    }
    const imports = getImports();
